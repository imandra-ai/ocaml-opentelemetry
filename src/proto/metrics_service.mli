...
val set_export_metrics_service_request_resource_metrics : export_metrics_service_request -> Metrics.resource_metrics list -> unit
...
val has_export_metrics_partial_success_rejected_data_points : export_metrics_partial_success -> bool
  (** presence of field "rejected_data_points" in [export_metrics_partial_success] *)

val set_export_metrics_partial_success_rejected_data_points : export_metrics_partial_success -> int64 -> unit
  (** set field rejected_data_points in export_metrics_partial_success *)

val has_export_metrics_partial_success_error_message : export_metrics_partial_success -> bool
  (** presence of field "error_message" in [export_metrics_partial_success] *)

val set_export_metrics_partial_success_error_message : export_metrics_partial_success -> string -> unit
...
val set_export_metrics_service_response_partial_success : export_metrics_service_response -> export_metrics_partial_success -> unit
